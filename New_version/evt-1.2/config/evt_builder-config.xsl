...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
	...
	<xsl:param name="index_title" select="'Pembroke 25'"/>
	...
	<xsl:param name="welcomeMsg">
		<div>
			<p class="title main">Welcome to the transcription of Pembroke 25!</p> 
		</div>
		...
		<div>If you have any suggestions or spot an error/bug please contact us at <a href="mailto:evt.developers@gmail.com">[contact here]</a></div>
	</xsl:param>
