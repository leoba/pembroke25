...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
					...
					<xsl:when test="tei:support or tei:extent or tei:collation or tei:condition or tei:foliation">
						<xsl:if test="tei:support and tei:support/normalize-space() != ''">
							<div class="row">
								...
								<div class="right_col"><xsl:apply-templates select="tei:support"/></div>
							</div>
						</xsl:if>
						<xsl:if test="tei:extent and tei:extent/normalize-space() != ''">
							<div class="row">
								...
								<div class="right_col"><xsl:apply-templates select="tei:extent"/></div>
							</div>
						</xsl:if>
						<xsl:if test="tei:collation and tei:collation/normalize-space() != ''">
							<div class="row">
								...
								<div class="right_col"><xsl:apply-templates select="tei:collation"/></div>
							</div>
						</xsl:if>
						<xsl:if test="tei:condition and tei:condition/normalize-space() != ''">
							<div class="row">
								...
								<div class="right_col"><xsl:apply-templates select="tei:condition"/></div>
							</div>
						</xsl:if>
						<xsl:if test="tei:foliation and tei:foliation/normalize-space() != ''">
							<div class="row">
								...
								<div class="right_col"><xsl:apply-templates select="tei:foliation"/></div>
							</div>
						</xsl:if>
					</xsl:when>
					<xsl:otherwise>
			...
			<div class="table">
				<xsl:if test="tei:layout and tei:layout/normalize-space() != ''">
					<div class="row">
						...
						<div class="right_col"><xsl:apply-templates select="tei:layout"/></div>
					</div>
				</xsl:if>
				<xsl:if test="tei:summary and tei:summary/normalize-space() != ''">
					<div class="row">
						...
						<div class="right_col"><xsl:apply-templates select="tei:summary"/></div>
					</div>
				</xsl:if>
			</div>
		</div>
			...
			<div class="table">
				...
				<xsl:if test="tei:origin and tei:origin/normalize-space() != ''">
					<div class="row">
						...
						<div class="right_col"><xsl:apply-templates select="tei:origin"/></div>
					</div>
				</xsl:if>
				<xsl:if test="tei:acquisition and tei:acquisition/normalize-space() != ''">
					<div class="row">
						...
						<div class="right_col"><xsl:apply-templates select="tei:acquisition"/></div>    
					</div>
				</xsl:if>
				<xsl:if test="tei:provenance and tei:provenance/normalize-space() != ''">
					<div class="row">
						...
						<div class="right_col"><xsl:apply-templates select="tei:provenance"/></div>
					</div>
				</xsl:if>    
			</div>
		</div>
			...
			<div class="table">
				<xsl:if test="tei:adminInfo and tei:adminInfo/normalize-space() != ''">
					<div class="row">
						...
						<div class="right_col"><xsl:apply-templates select="tei:adminInfo"/></div>
					</div>
				</xsl:if>
				<xsl:if test="tei:surrogates and tei:surrogates/normalize-space() != ''">
					<div class="row">
						...
						<div class="right_col"><xsl:apply-templates select="tei:surrogates"/></div>
					</div>
				</xsl:if>    
			</div>
		</div>
	...
	<xsl:template match="//tei:hi">
		<xsl:choose>
			...
			<xsl:when test="@rend='ital'"><i><xsl:apply-templates/></i></xsl:when>
